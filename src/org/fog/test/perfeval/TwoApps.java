...
public class TwoApps {
	...
	private static Application createApplication0(String appId, int userId){
		 ...
		 */
		application.addAppModule("client", 10 ,0); // adding module Client to the application model
		application.addAppModule("concentration_calculator", 10, 1); // adding module Concentration Calculator to the application model
		application.addAppModule("connector", 10, 2); // adding module Connector to the application model
	...
	private static Application createApplication1(String appId, int userId){
		 ...
		 * Adding modules (vertices) to the application model (directed graph)
		 */
		application.addAppModule("client_1", 10, 0); // adding module Client to the application model
		application.addAppModule("concentration_calculator_1", 10, 1); // adding module Concentration Calculator to the application model
		application.addAppModule("connector_1", 10,2); // adding module Connector to the application model
