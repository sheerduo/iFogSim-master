...
public class Application {
	 ...
	 * @param ram
	 */
	public void addAppModule(String moduleName, int ram, int level){
		int mips = 1000;
		long size = 10000;
		long bw = 1000;
		String vmm = "Xen";
		...
		AppModule module = new AppModule(FogUtils.generateEntityId(), moduleName, appId, userId, 
				mips, ram, bw, size, vmm, new TupleScheduler(mips, 1), new HashMap<Pair<String, String>, SelectivityModel>(),level);
		
		getModules().add(module);
		System.out.println(moduleName + " : " + module.getUid());
	}

	public void addAppModule(String moduleName, int mips, int ram, long bw, int level){
		//int mips = 1000;
		long size = 10000;
		//long bw = 1000;
		String vmm = "Xen";
	...
	public void addAppModule(String moduleName, int mips, int ram, long bw){
		//int mips = 1000;
		long size = 10000;
		//long bw = 1000;
		String vmm = "Xen";
	 ...
	 */
	public void addAppEdge(String source, String destination, double tupleCpuLength,
						   double tupleNwLength, String tupleType, int direction, int edgeType, int deadline, int level){
		AppEdge edge = new AppEdge(source, destination, tupleCpuLength, tupleNwLength, tupleType, direction, edgeType, deadline, level);
		getEdges().add(edge);
		getEdgeMap().put(edge.getTupleType(), edge);
	}
	...
	public List<Tuple> getResultantTuples(String moduleName, Tuple inputTuple, int sourceDeviceId, int sourceModuleId){
		...
		for(AppEdge edge : getEdges()){
			//System.out.println(moduleName + "  " + edge.getSource());
