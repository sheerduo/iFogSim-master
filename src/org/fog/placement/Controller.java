...
public class Controller extends SimEntity{
	...
	private void printTimeDetails() {
		...
		for(Integer loopId : TimeKeeper.getInstance().getLoopIdToTupleIds().keySet()){
			...
			System.out.println(getStringForLoopId(loopId) + " ---> "+TimeKeeper.getInstance().getLoopIdToCurrentAverage().get(loopId) + " nums: " + TimeKeeper.getInstance().getLoopIdToCurrentNum().get(loopId));
		}
		...
		for(String tupleType : TimeKeeper.getInstance().getTupleTypeToAverageCpuTime().keySet()){
			System.out.println(tupleType + " ---> "+TimeKeeper.getInstance().getTupleTypeToAverageCpuTime().get(tupleType) + " nums: " + TimeKeeper.getInstance().getTupleTypeToExecutedTupleCount().get(tupleType));
		}
